...
<head>
    ...
    <title>Lista de Relógios - Relojoaria</title>
...
echo "<td>";
if (!empty($row['foto_relogio'])) {
    
    echo "<img class='thumb' src='{$row['foto_relogio']}' onclick=\"showPopup('{$row['foto_relogio']}')\">";
} else {
    echo "N/A";
}
echo "</td>";
                        echo "<td>
                                <a href='EditarRelogio.php?id={$row['id_relogio']}' class='btn-acao editar'>Editar</a>
                                <a href='ExcluirRelogio.php?id={$row['id_relogio']}' class='btn-acao excluir' onclick='return confirm(\"Tem certeza que deseja excluir?\")'>Excluir</a>
                            </td>";
                        echo "</tr>";
                    }
                } else {
                    
                    echo "<tr><td colspan='6' style='text-align: center;'>Nenhum Relogio cadastrado.</td></tr>";
                }
                ?>
            </tbody>
        </table>
